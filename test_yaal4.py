...
class TestGravity(unittest.TestCase):
    ...
    def test_complex1_array_object_lower_keys_deep(self):
       ...
       self.assertDictEqual(_to_lower_keys_deep(obj), {"a": "a", "b": "B", "c": {"d":"d","a":"a"},"array":[{"f":"f", "g": "g"}]})
    ...
    def test_build_twigs_with_params(self):
       ...
       _build_twigs(branch, lines, {})
       expected = { "parameters":{"a":{"name":"a", "type": "integer"}}, "twigs":[{"content":"select {{A}}, {{A}}","parameters":[{"name":"a","type":"integer"},{"name":"a","type":"integer"}]}]}  
    ...
    def test_build_twigs_double_query(self):
	 ...
	 "select {{a}}"
       ...
       branch = { "parameters": { "a" : { "name": "a", "type": "integer" } } }
       _build_twigs(branch, lines, {})
       expected = { "parameters":{"a":{"name":"a", "type": "integer"}}, "twigs":[{"content":"select {{A}}, {{A}}","parameters":[{"name":"a","type":"integer"},{"name":"a","type":"integer"}]},{"content":"select {{a}}", "parameters":[{"name":"a", "type": "integer"}]}]}  
       self.assertDictEqual(branch, expected)
    ...
    def test_build_twigs4(self):
	 ...
	 "--query()--",
       ...
       branch = { "parameters": { "a" : { "name": "a", "type": "integer" } } }
       _build_twigs(branch, lines, {})
       expected = { "parameters":{"a":{"name":"a", "type": "integer"}}, "twigs":[]}  
       self.assertDictEqual(branch, expected)
    ...
    def test_build_branch(self):
       branch, bag, payload_model = {"path": "order/get", "method": "$", "parameters":{"$query.id":{"name":"$query.id", "type": "integer"}}}, {}, {"type": "object"}
       output_model, model, content_reader = {}, {"query": {}}, ContentReader()
       expected = {'path': 'order/get', 'method': '$', "twigs" : [{"content": " select {{$query.id}}", "parameters" : [{"name":"$query.id", "type":"integer"}]}], "parameters":{"$query.id":{"name":"$query.id", "type": "integer"}}, 'input_type': 'object', 'output_type': 'array', 'use_parent_rows': False, 'branches': [{'name': 'data', 'method': '$.data', 'path': 'order/get', 'input_type': 'object', 'output_type': 'array', 'use_parent_rows': False}, {'name': 'paging', 'method': '$.paging', 'path': 'order/get', 'input_type': 'object', 'output_type': 'array', 'use_parent_rows': False}]}
    ...
    def test_build_branch1(self):
       ...
       output_model, model, content_reader = {}, {"query": {}}, ContentReader()
       tree_map = {"data":{}}
       expected = {'path': 'order/get', 'method': '$',"twigs" : [{"content": " select {{$query.id}}", "parameters" : [{"name":"$query.id", "type":"integer"}]}], "parameters":{"$query.id":{"name":"$query.id", "type": "integer"}}, 'input_type': 'object', 'output_type': 'array', 'use_parent_rows': False, 'branches': [{'name': 'data', 'method': '$.data', 'path': 'order/get', 'input_type': 'object', 'output_type': 'array', 'use_parent_rows': False}]}
    ...
    def test_build_branch2(self):
       branch, bag, payload_model = {"path": "order/get", "method": "$"}, {}, {"type": "object"}
       output_model, model, content_reader = {}, {"query":{}}, ContentReader()
       expected = {'path': 'order/get', 'method': '$', "twigs" : [{"content": " select {{$query.id}}", "parameters" : [{"name":"$query.id", "type":"integer"}]}], "parameters":{"$query.id":{"name":"$query.id", "type": "integer"}}, 'input_type': 'object', 'output_type': 'array', 'use_parent_rows': False, 'branches': [{'name': 'data', 'method': '$.data', 'path': 'order/get', 'input_type': 'object', 'output_type': 'array', 'use_parent_rows': False, "branches":[{"name":"items", "method": "$.data.items", "path": "order/get", "input_type": "object", "output_type": "array", "use_parent_rows": False}]}, {'name': 'paging', 'method': '$.paging', 'path': 'order/get', 'input_type': 'object', 'output_type': 'array', 'use_parent_rows': False}]}
       _build_branch(branch, {"data":{"items":{}}, "paging": {}}, content_reader, payload_model, output_model, model, bag)
       self.assertDictEqual(branch, expected)
