...
License: [MIT](LICENSE). Version: `0.5.0` (Python package + NuGet metadata). Python and .NET 8 share the same descriptor files.
...
C# / .NET 8: `dotnet add package Yaal` (`0.5.0`), then add the client your app uses:
