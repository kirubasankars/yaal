...
License: [MIT](LICENSE). Version: `0.6.0` (Python package + NuGet metadata). Python and .NET 8 share the same descriptor files.
...
C# / .NET 8: `dotnet add package Yaal` (`0.6.0`), then add the client your app uses:
