...
def _build_branch(branch, map_by_files, content_reader, payload_model, output_model, model, bag):
    ...
    for sub_branch_name in branch_map:
        ...
        branch_payload_model = input_properties[sub_branch_name]

        if output_properties and sub_branch_name in output_properties:
            branch_output_model = output_properties[sub_branch_name]

        branch_payload_model["$parent"] = payload_model

        _build_branch(sub_branch, sub_branch_map, content_reader, branch_payload_model, branch_output_model, model, bag)

        del branch_payload_model["$parent"]
