...
class TestYaal(unittest.TestCase):
    ...
    def test_trunk_with_parameters_query_check(self):
        yaal = Yaal("/path", FakeContentReader(), debug=True)
        descriptor = yaal.create_descriptor("get1/get")
    ...
    def test_trunk_with_parameters_queries_check(self):
        yaal = Yaal("/path", FakeContentReader1(), debug=True)
        descriptor = yaal.create_descriptor("get1/get")
