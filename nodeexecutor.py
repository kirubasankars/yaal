...
class NodeExecutor:
    ...
    def _get_queries_output(self, input_type, node_descriptor, execution_contexts, input_shape):        
        ...
        try:
            ...
            if input_type is not None and input_type == "array":
                ...
                for i in range(0, length):
                    ...
                    output.extend(self._get_queries_output(input_type, node_descriptor, execution_contexts, item_input_shape))
            
            elif input_type is None or input_type == "object":                
                output = self._get_queries_output(input_type, node_descriptor, execution_contexts, input_shape)
